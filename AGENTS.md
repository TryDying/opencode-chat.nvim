...
- If all remaining windows in the current tab are opencode-chat panes, automatically close the Chat panes; keep Neovim alive by creating a normal empty window first if needed.
